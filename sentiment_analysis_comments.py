...
comments_df = pd.read_csv("data/clustered_comments_BERT.csv")
...
with open("sentiment infor/sentiment_cluster_stats_comments.txt", "w") as f:
...
comments_df.to_csv("data/comments_with_sentiment_analysis.csv", index=False)