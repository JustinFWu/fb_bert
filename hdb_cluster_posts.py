...
embeddings = torch.load("embeddings/post_embeddings_BERT.pt")
...
output_path = "hdb-clusters/posts_hdbscan_summary_BERT.txt"
...
dataframe.to_csv("data/clustered_posts_BERT.csv", index=False)
